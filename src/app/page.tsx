  ...
  return (
    ...
    <div>
      ...
      <div className="w-full h-screen bg-[#16161d] pt-10" >
       ...
       <h1 className="text-white text-center text-[25px] mt-10" > Manage Your  Spaer parts </h1>


       <div className="w-full h-[300px] mt-12 flex justify-center gap-5 items-center  "> 


        <button onClick={()=>{router.push("/viewpart")}}   className="w-[100px] h-[30px] bg-blue-400 rounded-md" > View List  </button>
